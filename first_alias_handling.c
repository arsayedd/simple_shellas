...
/**
 * hand_alias - handle alias command (char **)
...
/**
 * gt_alias_value - get value of alias
...
/**
 * gt_alias_ind - get index of alias
...
/**
 * alias_change - replace alias in command
